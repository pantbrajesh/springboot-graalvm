...
![alt text](https://github.com/pantbrajesh/springboot-graalvm/tree/master/reactive-h2/images/StandardBootTime.png?raw=true)

The standard way takes about ```6.311``` seconds to start up and it uses around ```767``` MB of RAM:

![alt text](https://github.com/pantbrajesh/springboot-graalvm/tree/master/reactive-h2/images/StandarMemory.png?raw=true)

Now comparing our Natively compiled Spring Boot App, we see a startup time of about ```1.295``` seconds:

![alt text](https://github.com/pantbrajesh/springboot-graalvm/tree/master/reactive-h2/images/NativeBootTime.png?raw=true)

and uses only ```165MB``` of RAM:

![alt text](https://github.com/pantbrajesh/springboot-graalvm/tree/master/reactive-h2/images/NativeMemory.png?raw=true)
